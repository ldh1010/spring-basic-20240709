package com.ldh.springbasic.config;
...
import com.ldh.springbasic.filter.JwtAuthenticationFilter;
import com.ldh.springbasic.handler.OAuth2SuccessHandler;
import com.ldh.springbasic.service.implement.OAuth2UserServiceImplement;
...
@Configurable
// @Configuration:
// - 생성자나 '메서드'가 호출 시에 Spring Bean으로 등록하게 하는 어노테이션
@Configuration
// @EnableWebSecurity:
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        security
            ...
            .authorizeHttpRequests(request -> request
                // requestMatchers(): URL 패터느 HTTP 메서드 + URL 페턴, HTTP 메서드 마다 접근 허용 방식을 지정하는 메서드
                ...
                // anyRequest(): requestMatcher로 지정한 메서드 혹은 URL이 아닌 모든 요청
...
// 인증 및 인가 실패 처리를 위한 커스텀 예외 (인터페이스 구현)
